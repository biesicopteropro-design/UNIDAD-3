...
def abrir_registro_productos():
    ...
    btn_guardar = tk.Button(reg, text="Guardar Producto", font=("Arial", 12),
                            bg="#000000", fg="white", command=guardar_producto)
...
# -------------------------------------------------
ventana = tk.Tk()
ventana.title("Punto de Venta  kansas")
...
btn_reg_ventas = ttk.Button(ventana, text="Registro de Ventas",
                            style="BotonNegro.TButton", command=abrir_registro_ventas)
btn_reg_ventas.pack(pady=10)

btn_reportes = ttk.Button(ventana, text="Reportes",
                          style="BotonNegro.TButton", command=abrir_reportes)
